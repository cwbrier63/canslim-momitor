...
# Default log directory - FIXED to use correct path
DEFAULT_LOG_DIR = os.path.join(
    os.environ.get('CANSLIM_LOG_DIR', r'C:\Trading\canslim_monitor'),
    'logs'
)
...
LOG_CATEGORIES = {
    ...
    'position': 'threads',
    'market': 'threads',
    'regime': 'threads',  # Market regime thread
    'ibkr': 'integrations',
...
DEFAULT_LOG_LEVELS = {
    ...
    'regime': logging.DEBUG,  # Market regime thread
    'ibkr': logging.DEBUG,
...
def get_regime_logger() -> logging.Logger:
    """Get the regime thread logger."""
    return get_logger('regime')
